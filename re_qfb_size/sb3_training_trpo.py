...
"""
This script follows on sb3_training_ppo.py
...
experiment_name = f"TRPO_{dt.strftime(dt.now(), '%m%d%y_%H%M%S')}"
...
for random_seed in (123,):# 234, 345, 456, 567):
    ...
    model = TRPO(PPOPolicy, env, **trpo_params)
